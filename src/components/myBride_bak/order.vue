    ...
    <div class="message content clearfix" style="padding-bottom:0;" >
		<div class="left " >
			<div class="love-content">
				<div class="main-img">
					<img :src="$route.params.MainImg.indexOf('http')>-1?$route.params.MainImg:http.imgUrl+$route.params.MainImg" v-if="$route.params.MainImg"/>
							...
							<div class="img-fingerprint list">
								<div class="imgbox">
			                		...
			                		<div class="img" v-show='manAdditional.ImgUrl != "" '>
			                			<!-- <img :src="http.imgUrl+manAdditional.Id" /> -->
			                		</div>
						...
						<div class="list-box">
							...
							<div class="img-fingerprint list">
								<div class="imgbox">
			                		...
			                		<div class="img" v-if='womenAdditional.ImgUrl != "" '>
...
export default {
    ...
    created(){
		...
		// }
		if(!this.$route.params.detailsList){
			this.$router.go(-1);
		}
		this.gSkuId = true;
    ...
    methods:{
        ...
        getDeliveryType(){
            ...
            var cbok = res =>{
                ...
                this.order.DeliverGoodsId = this.deliveryType[0].Id
    			this.order.DeliverGoodsName= this.deliveryType[0].ValueName
            };
    	...
    	create_order(){
			...
			this.order.DetailsList = this.$route.params.detailsList;
			this.order.DetailsList[0].Lettering = this.womenAdditional.Lettering;
			this.order.DetailsList[0].Name = this.womenAdditional.Name;
			this.order.DetailsList[0].ImgUrl = this.womenAdditional.ImgUrl.slice(this.womenAdditional.ImgUrl.lastIndexOf('_')+1);
			this.order.DetailsList[0].Typeface = this.womenAdditional.Typeface;
    		this.loading();
    		var that = this;
            if(this.tab == 0){
